...
const products = [
  {
    title: "Gold Bars",
    desc: "High-purity gold bars supplied with international certification standards for global trading and investment.",
    icon: "🪙",
  },
  {
    title: "Gold Jewellery",
    desc: "BIS hallmarked gold jewellery crafted for export markets with premium quality and authenticity.",
    icon: "💍",
  },
  {
    title: "Silver Products",
    desc: "Certified silver jewellery and artefacts designed for global export with purity assurance.",
    icon: "🥈",
  },
  {
    title: "Global Commodities",
    desc: "Reliable supply of agricultural and food commodities with strong logistics and international distribution.",
    icon: "🌾",
  },
];
  ...
  return (
    <section className="relative py-24 px-6 bg-[#111116] overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        >
          We specialize in gold import export, silver trading, and global commodity
          supply with certified international standards and secure trading systems.
        </motion.p>
